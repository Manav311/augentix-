...
#define FRAME_FILE_END_INDEX_H264   (600)
#define FRAME_FILE_PATH_FORMAT_H264 FRAME_FILE_PATH_PREFIX "h264_2k_30fp/frame-%03d" FRAME_FILE_POSTFIX_H264
#define FRAME_FILE_DURATION_US_H264 (1000 * 1000 / 30UL)

#define FRAME_FILE_FPS_H265         20UL
#define FRAME_FILE_POSTFIX_H265     ".h265"
#define FRAME_FILE_START_INDEX_H265 (1)
#define FRAME_FILE_END_INDEX_H265   (600)
#define FRAME_FILE_PATH_FORMAT_H265 FRAME_FILE_PATH_PREFIX "h265/frame-%03d" FRAME_FILE_POSTFIX_H265
#define FRAME_FILE_DURATION_US_H265 (1000 * 1000 / FRAME_FILE_FPS_H265)
...
#ifdef USE_H265
    fileHandle->capability.formats = (1 << (VID_FMT_H265 - 1));
    fileHandle->capability.resolutions = (1 << (VID_RES_2K - 1));
#else
...
#ifdef USE_H265
        case VID_FMT_H265:
            fileHandle->framePathFormat = FRAME_FILE_PATH_FORMAT_H265;
            fileHandle->frameIndexStart = FRAME_FILE_START_INDEX_H265;
            fileHandle->frameIndexEnd = FRAME_FILE_END_INDEX_H265;
            break;
#else
        case VID_FMT_H264:
...
#ifdef USE_H265
    usleep(FRAME_FILE_DURATION_US_H265);
#else
