...
if [ $1 == '--help' ]; then
	...
	echo ""
	echo " Usage_DST"
	echo " sh /system/script/DSTConf.sh set GMT[offset]DST[offset],M[m].[w].[d]/[hr],M[m2].[w2].[d2]/[hr2]"
	echo ""
	...
	echo ""
	echo " Usage_Enabled"
	echo " sh /system/script/DSTConf.sh setEnabled [Manual_enabled] [DST_enabled] [Manual_SyncWithPC_enabled]"
	echo ""
	echo " Example:"
	echo " sh /system/script/SntpConf.sh set GMT+5DST,M3.2.0/2,M11.1.0/2"
	echo " sh /system/script/SntpConf.sh set GMT+8"
	echo " sh /system/script/SntpConf.sh setEnabled 0 0 1"
fi
