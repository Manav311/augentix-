...
MPEG4LATMAudioRTPSink::MPEG4LATMAudioRTPSink(UsageEnvironment &env, Groupsock *RTPgs, u_int8_t rtpPayloadFormat,
...
{
	return new MPEG4LATMAudioRTPSink(env, RTPgs, rtpPayloadFormat, rtpTimestampFrequency, streamMuxConfigString,
	                                 numChannels, allowMultipleFramesPerPacket);
}
...
void MPEG4LATMAudioRTPSink::doSpecialFrameHandling(unsigned fragmentationOffset, unsigned char *frameStart,
