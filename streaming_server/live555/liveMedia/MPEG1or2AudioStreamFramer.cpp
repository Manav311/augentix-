...
MPEG1or2AudioStreamFramer::MPEG1or2AudioStreamFramer(UsageEnvironment &env, FramedSource *inputSource,
...
MPEG1or2AudioStreamFramer *MPEG1or2AudioStreamFramer::createNew(UsageEnvironment &env, FramedSource *inputSource,
                                                                Boolean syncWithInputSource)
{
...
void MPEG1or2AudioStreamFramer::continueReadProcessing(void *clientData, unsigned char * /*ptr*/, unsigned /*size*/,
...
#ifdef DEBUG
		fprintf(stderr, "MPEG1or2AudioStreamParser::parse() EXCEPTION (This is "
