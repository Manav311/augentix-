...
class MPEG2TransportUDPServerMediaSubsession : public OnDemandServerMediaSubsession {
	...
	createNew(UsageEnvironment &env,
	          char const *inputAddressStr, // An IP multicast address, or use
	          // "0.0.0.0" or NULL for unicast input
	          Port const &inputPort,
	          Boolean inputStreamIsRawUDP = False); // otherwise (default) the input stream is RTP/UDP
    protected:
	MPEG2TransportUDPServerMediaSubsession(UsageEnvironment &env, char const *inputAddressStr,
