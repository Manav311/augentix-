...
class MPEG2TransportStreamIndexFile : public Medium {
	...
	void lookupPCRFromTSPacketNum(unsigned long &tsPacketNumber, Boolean reverseToPreviousCleanPoint, float &pcr,
	...
	Boolean readIndexRecordValues(unsigned long indexRecordNum, unsigned long &transportPacketNum, u_int8_t &offset,
	...
	int mpegVersion();
	// returns the best guess for the version of MPEG being used for data within
	// the underlying Transport Stream file.
	// (1,2,4, or 5 (representing H.264).  0 means 'don't know' (usually because
