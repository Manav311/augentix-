...
class RTCPInstance : public Medium {
	...
	// (To remove an existing "BYE" handler, call "setByeHandler()" again, with a
	// "handlerTask" of NULL.)
	...
	void unsetSpecificRRHandler(netAddressBits fromAddress,
	                            Port fromPort); // equivalent to setSpecificRRHandler(..., NULL, NULL);
    ...
    protected:
	RTCPInstance(UsageEnvironment &env, Groupsock *RTPgs, unsigned totSessionBW, unsigned char const *cname,
