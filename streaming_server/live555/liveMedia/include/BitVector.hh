...
class BitVector {
	...
	// Returns the value of the next bits, assuming that they were encoded using
	// an exponential-Golomb code of order 0
...
void shiftBits(unsigned char *toBasePtr, unsigned toBitOffset, unsigned char const *fromBasePtr, unsigned fromBitOffset,
               unsigned numBits);
