...
class MPEG4GenericRTPSource : public MultiFramedRTPSource {
    public:
	static MPEG4GenericRTPSource *createNew(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
    ...
    private:
	MPEG4GenericRTPSource(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
