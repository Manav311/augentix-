...
class JPEGVideoFileServerMediaSubsession : public FileServerMediaSubsession {
    public:
	static JPEGVideoFileServerMediaSubsession *createNew(UsageEnvironment &env, char const *fileName,
    ...
    protected:
	JPEGVideoFileServerMediaSubsession(UsageEnvironment &env, char const *fileName, Boolean reuseFirstSource,
	                                   double frameRate);
