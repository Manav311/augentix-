...
class AMRAudioRTPSink : public AudioRTPSink {
    public:
	static AMRAudioRTPSink *createNew(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
	                                  Boolean sourceIsWideband = False, unsigned numChannelsInSource = 1);
    ...
    protected:
	AMRAudioRTPSink(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
