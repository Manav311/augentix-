...
JPEGMediaSubsession::JPEGMediaSubsession(UsageEnvironment &env, Boolean reuseFirstSource)
...
RTPSink *JPEGMediaSubsession::createNewRTPSink(Groupsock *rtpGroupsock, unsigned char rtpPayloadTypeIfDynamic,
