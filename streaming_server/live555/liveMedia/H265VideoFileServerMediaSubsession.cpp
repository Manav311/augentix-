...
H265VideoFileServerMediaSubsession::createNew(UsageEnvironment &env, char const *fileName, Boolean reuseFirstSource)
{
	return new H265VideoFileServerMediaSubsession(env, fileName, reuseFirstSource);
}

H265VideoFileServerMediaSubsession::H265VideoFileServerMediaSubsession(UsageEnvironment &env, char const *fileName,
...
char const *H265VideoFileServerMediaSubsession::getAuxSDPLine(RTPSink *rtpSink, FramedSource *inputSource)
{
	...
	if (fDummyRTPSink == NULL) { // we're not already setting it up for another, concurrent stream
		...
		// payload-format
		// specific parameters in the SDP description) isn't known until we start
		// reading the file.
...
FramedSource *H265VideoFileServerMediaSubsession::createNewStreamSource(unsigned /*clientSessionId*/,
                                                                        unsigned &estBitrate)
{
...
RTPSink *H265VideoFileServerMediaSubsession::createNewRTPSink(Groupsock *rtpGroupsock,
