...
class NetAddress {
    public:
	NetAddress(u_int8_t const *data, unsigned length = 4 /* default: 32 bits */);
...
// A mechanism for displaying an IPv4 address in ASCII.  This is intended to
// replace "inet_ntoa()", which is not thread-safe.
class AddressString {
    public:
    ...
    private:
	char *fVal; // The result ASCII string: allocated by the constructor; deleted
	        // by the destructor
};
