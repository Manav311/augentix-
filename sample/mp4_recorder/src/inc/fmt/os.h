...
class buffered_file {
	...
	template <typename... T> inline void print(string_view fmt, const T &... args)
	{
...
class FMT_API file {
	...
	enum { RDONLY = FMT_POSIX(O_RDONLY), // Open for reading only.
...
class FMT_API ostream {
	...
	template <typename... T> friend auto output_file(cstring_view path, T... params) -> ostream;
 ...
 */
template <typename... T> inline auto output_file(cstring_view path, T... params) -> ostream
{
