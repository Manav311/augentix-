...
int main(int argc, char **argv)
{
	...
	OSD_setImageBmp(g_osd_handle[0], 0, "/mnt/nfs/ethnfs/rect.bmp",
	...
	OSD_setImageBmp(g_osd_handle[0], 1, "/mnt/nfs/ethnfs/red.bmp",
	                (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
	...
	OSD_setImageBmp(g_osd_handle[0], 2, "/mnt/nfs/ethnfs/green.bmp",
	                (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
	...
	OSD_setImageBmp(g_osd_handle[0], 3, "/mnt/nfs/ethnfs/rect.bmp",
	                (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
	...
	OsdText txt = { .size = 16, .background = TRANSPARENT, .color = { 0xff, 0xff, 0xff } };
	snprintf(&txt.ttf_path[0], 128, "%s", "/system/mpp/font/SourceHanSansTC-Normal.otf");
	char text[64];

	snprintf(&text[0], 64, "Block 0%d", 4);
	memcpy(&txt.txt[0], &text[0], sizeof(text));
	include_canvas = g_osd_handle[0]->region[4].include_canvas;

	OSD_setTextUTF8(g_osd_handle[0], 4, &txt, (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
	...
	snprintf(&text[0], 64, "Block 0%d", 5);
	memcpy(&txt.txt[0], &text[0], sizeof(text));
	include_canvas = g_osd_handle[0]->region[5].include_canvas;
	OSD_setTextUTF8(g_osd_handle[0], 5, &txt, (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
	...
	snprintf(&text[0], 64, "Block 0%d", 6);
	memcpy(&txt.txt[0], &text[0], sizeof(text));
	include_canvas = g_osd_handle[0]->region[6].include_canvas;
	OSD_setTextUTF8(g_osd_handle[0], 6, &txt, (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
	...
	snprintf(&text[0], 64, "Block 0%d", 7);
	memcpy(&txt.txt[0], &text[0], sizeof(text));
	include_canvas = g_osd_handle[0]->region[7].include_canvas;
	OSD_setTextUTF8(g_osd_handle[0], 7, &txt, (char *)(g_osd_canvas_attr[0][include_canvas].canvas_addr));
