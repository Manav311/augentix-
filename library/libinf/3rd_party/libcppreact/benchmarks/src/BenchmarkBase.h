...
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename T, typename TGen> const std::vector<T> GetUniqueRandomNumbers(TGen gen, T from, T to, int count)
{
...
/// BenchmarkBase
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename D> class BenchmarkBase {
    public:
	typedef D Domain;
...
/// RunBenchmark
///////////////////////////////////////////////////////////////////////////////////////////////////
template <int RUN_COUNT, typename TBenchmark, typename TParams>
...
/// RunBenchmarkClass
///////////////////////////////////////////////////////////////////////////////////////////////////
template <int RUN_COUNT, template <typename> class TBenchmark, typename TParams, typename... Ds>
