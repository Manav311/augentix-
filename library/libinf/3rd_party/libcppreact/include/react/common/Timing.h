...
/// ConditionalTimer
///////////////////////////////////////////////////////////////////////////////////////////////////
template <long long threshold, bool is_enabled> class ConditionalTimer {
    public:
	class ScopedTimer {
	    public:
		// Note:
...
// Disabled
template <long long threshold> class ConditionalTimer<threshold, false> {
    public:
...
// Enabled
template <long long threshold> class ConditionalTimer<threshold, true> {
    public:
#if REACT_FIXME_CUSTOM_TIMER
