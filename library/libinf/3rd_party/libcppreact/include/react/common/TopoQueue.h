...
/***************************************/ REACT_IMPL_BEGIN /**************************************/
	...
	bool FetchNext()
	{
		...
		auto p = std::partition(queueData_.begin(), queueData_.end(), LevelCompFunctor{ minLevel_ });
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TIt, uint grain_size> class WeightedRange {
    public:
...
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename T, uint grain_size, typename TLevelFunc, typename TWeightFunc> class ConcurrentTopoQueue {
    private:
	struct Entry;
