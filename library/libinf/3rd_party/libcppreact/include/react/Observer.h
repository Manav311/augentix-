...
/// Observe - Signals
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename D, typename FIn, typename S> auto Observe(const Signal<D, S> &subject, FIn &&func) -> Observer<D>
{
	...
	using NodeT = typename std::conditional<std::is_same<void, R>::value, SignalObserverNode<D, S, WrapperT>,
...
/// Observe - Events
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename D, typename FIn, typename E> auto Observe(const Events<D, E> &subject, FIn &&func) -> Observer<D>
{
	using REACT_IMPL::IObserver;
	using REACT_IMPL::ObserverNode;
	...
	using WrapperT = typename std::conditional<
	        IsCallableWith<F, ObserverAction, EventRange<E> >::value, F,
	        typename std::conditional<
	                IsCallableWith<F, ObserverAction, E>::value, AddObserverRangeWrapper<E, F>,
	                typename std::conditional<
	                        ...
	                        typename std::conditional<
	                                ...
	                                AddObserverRangeWrapper<E, AddDefaultReturnValueWrapper<F, ObserverAction,
	                                                                                        ObserverAction::next> >,
...
auto Observe(const Events<D, E> &subject, const SignalPack<D, TDepValues...> &depPack, FIn &&func) -> Observer<D>
{
	using REACT_IMPL::IObserver;
	using REACT_IMPL::ObserverNode;
	...
	using WrapperT = typename std::conditional<
	        IsCallableWith<F, ObserverAction, EventRange<E>, TDepValues...>::value, F,
	        typename std::conditional<
	                ...
	                typename std::conditional<
	                        ...
	                        typename std::conditional<
	                                ...
	                                AddObserverRangeWrapper<
	                                        E, AddDefaultReturnValueWrapper<F, ObserverAction, ObserverAction::next>,
	                                        TDepValues...>,
	                                void>::type>::type>::type>::type;
	...
	struct NodeBuilder_ {
		...
		{
			return new NodeT(GetNodePtr(MySubject), std::forward<FIn>(MyFunc), GetNodePtr(deps)...);
		}
	...
	std::unique_ptr<ObserverNode<D> > nodePtr(
	        REACT_IMPL::apply(NodeBuilder_(subject, std::forward<FIn>(func)), depPack.Data));
