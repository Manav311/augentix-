...
class task_group_base : internal::no_copy {
	...
	template <typename F, typename Task> void internal_run(F &f)
	{
	...
	template <typename F> void run(task_handle<F> &h)
	{
...
class task_group : public internal::task_group_base {
	...
	template <typename F> void run(const F &f)
	{
...
template <class F> task_handle<F> make_task(const F &f)
{
