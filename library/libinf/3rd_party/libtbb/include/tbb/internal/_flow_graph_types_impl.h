...
template <template <class> class PT, typename TypeTuple> struct wrap_tuple_elements<1, PT, TypeTuple> {
	typedef typename tbb::flow::tuple<PT<typename tbb::flow::tuple_element<0, TypeTuple>::type> > type;
};
...
template <template <class> class PT, typename TypeTuple> struct wrap_tuple_elements<2, PT, TypeTuple> {
	typedef typename tbb::flow::tuple<PT<typename tbb::flow::tuple_element<0, TypeTuple>::type>,
...
struct wrap_key_tuple_elements<5, PT, KeyTraits, TypeTuple> {
	...
	typedef typename tbb::flow::tuple<PT<KeyTrait0>, PT<KeyTrait1>, PT<KeyTrait2>, PT<KeyTrait3>, PT<KeyTrait4> >
	        type;
};
...
struct wrap_key_tuple_elements<8, PT, KeyTraits, TypeTuple> {
	...
	typedef typename tbb::flow::tuple<PT<KeyTrait0>, PT<KeyTrait1>, PT<KeyTrait2>, PT<KeyTrait3>, PT<KeyTrait4>,
	                                  PT<KeyTrait5>, PT<KeyTrait6>, PT<KeyTrait7> >
	        type;
};
#endif
...
struct wrap_key_tuple_elements<9, PT, KeyTraits, TypeTuple> {
	...
	typedef typename tbb::flow::tuple<PT<KeyTrait0>, PT<KeyTrait1>, PT<KeyTrait2>, PT<KeyTrait3>, PT<KeyTrait4>,
	                                  PT<KeyTrait5>, PT<KeyTrait6>, PT<KeyTrait7>, PT<KeyTrait8> >
	        type;
};
#endif
...
struct wrap_key_tuple_elements<10, PT, KeyTraits, TypeTuple> {
	...
	typedef typename tbb::flow::tuple<PT<KeyTrait0>, PT<KeyTrait1>, PT<KeyTrait2>, PT<KeyTrait3>, PT<KeyTrait4>,
	                                  PT<KeyTrait5>, PT<KeyTrait6>, PT<KeyTrait7>, PT<KeyTrait8>, PT<KeyTrait9> >
	        type;
};
#endif
...
//TODO: Should we reject lists longer than a tuple can hold?
	...
	class variant {
		...
		template <typename U> bool variant_is_a() const
		{
...
template <typename V, typename T> const V &cast_to(T const &t)
{
	return t.template cast_to<V>();
}

template <typename V, typename T> bool is_a(T const &t)
{
