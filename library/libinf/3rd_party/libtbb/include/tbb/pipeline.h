...
class filter : internal::no_copy {
	...
	filter(bool is_serial_)
	        ...
	        , my_filter_mode(
	                  static_cast<unsigned char>((is_serial_ ? serial : parallel) | exact_exception_propagation))
...
template <typename T, typename U, typename Body> filter_t<T, U> make_filter(tbb::filter::mode mode, const Body &body)
{
