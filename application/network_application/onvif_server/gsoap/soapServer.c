...
SOAP_SOURCE_STAMP("@(#) soapServer.c ver 2.8.60 2019-05-09 08:41:10 GMT")
...
{	struct __tr2__GetAnalyticsConfigurations soap_tmp___tr2__GetAnalyticsConfigurations;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tr2__GetAnalyticsConfigurationsResponse(soap, &tr2__GetAnalyticsConfigurationsResponse, "tr2:GetAnalyticsConfigurationsResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tr2__GetAudioOutputConfigurations soap_tmp___tr2__GetAudioOutputConfigurations;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tr2__GetAudioOutputConfigurationsResponse(soap, &tr2__GetAudioOutputConfigurationsResponse, "tr2:GetAudioOutputConfigurationsResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tr2__GetAudioDecoderConfigurations soap_tmp___tr2__GetAudioDecoderConfigurations;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tr2__GetAudioDecoderConfigurationsResponse(soap, &tr2__GetAudioDecoderConfigurationsResponse, "tr2:GetAudioDecoderConfigurationsResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tr2__SetAudioOutputConfiguration soap_tmp___tr2__SetAudioOutputConfiguration;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_tr2__SetConfigurationResponse(soap, &tr2__SetAudioOutputConfigurationResponse, "tr2:SetAudioOutputConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tr2__SetAudioDecoderConfiguration soap_tmp___tr2__SetAudioDecoderConfiguration;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put_tr2__SetConfigurationResponse(soap, &tr2__SetAudioDecoderConfigurationResponse, "tr2:SetAudioDecoderConfigurationResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tr2__GetAudioOutputConfigurationOptions soap_tmp___tr2__GetAudioOutputConfigurationOptions;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tr2__GetAudioOutputConfigurationOptionsResponse(soap, &tr2__GetAudioOutputConfigurationOptionsResponse, "tr2:GetAudioOutputConfigurationOptionsResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
...
{	struct __tr2__GetAudioDecoderConfigurationOptions soap_tmp___tr2__GetAudioDecoderConfigurationOptions;
	...
	{	if (soap_envelope_begin_out(soap)
		 || soap_putheader(soap)
		 || soap_body_begin_out(soap)
		 || soap_put__tr2__GetAudioDecoderConfigurationOptionsResponse(soap, &tr2__GetAudioDecoderConfigurationOptionsResponse, "tr2:GetAudioDecoderConfigurationOptionsResponse", "")
		 || soap_body_end_out(soap)
		 || soap_envelope_end_out(soap))
			 return soap->error;
	};
