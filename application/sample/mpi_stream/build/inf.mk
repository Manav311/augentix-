...
ifeq ($(CONFIG_LIBINF_TFLITE), y)
	...
	CONFIG_INF_LIB := tensorflow-lite
	CONFIG_INF_SET := y
...
ifeq ($(CONFIG_LIBINF_TFLITE_OPTIM), y)
	...
	CONFIG_INF_LIB := tensorflow-lite-optim
	CONFIG_INF_SET := y
...
ifeq ($(CONFIG_LIBINF_MICROLITE), y)
	...
	CONFIG_INF_LIB :=tensorflow-microlite
	CONFIG_INF_SET := y
...
ifeq ($(CONFIG_LIBINF_REMOTE_CORE), y)
	...
	CONFIG_INF_LIB_PATH += $(LIBAMPC_LIB)
	CONFIG_INF_LIB_PATH += $(LIBMETAL_LIB)
	CONFIG_INF_LIB_PATH += $(LIBOPENAMP_LIB)
	CONFIG_INF_LIB_PATH += $(BUILDROOT_OUTPUT_BUILD_PATH)/libsysfs-2.1.0/lib/.libs
