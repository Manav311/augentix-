...
template <typename D, typename E> class EventStreamNode;

///////////////////////////////////////////////////////////////////////////////////////////////////
/// AddContinuationRangeWrapper
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename E, typename F, typename... TArgs> struct AddContinuationRangeWrapper {
...
/// ContinuationNode
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename D> class ContinuationNode : public NodeBase<D> {
    public:
...
class SignalContinuationNode : public ContinuationNode<D> {
    ...
    public:
	template <typename F>
	SignalContinuationNode(TransactionFlagsT turnFlags, const std::shared_ptr<SignalNode<D, S> > &trigger, F &&func)
...
class EventContinuationNode : public ContinuationNode<D> {
    ...
    public:
	template <typename F>
	EventContinuationNode(TransactionFlagsT turnFlags, const std::shared_ptr<EventStreamNode<D, E> > &trigger,
	                      F &&func)
...
class SyncedContinuationNode : public ContinuationNode<D> {
    ...
    public:
	template <typename F>
	SyncedContinuationNode(TransactionFlagsT turnFlags, const std::shared_ptr<EventStreamNode<D, E> > &trigger,
	                       F &&func, const std::shared_ptr<SignalNode<D, TDepValues> > &... deps)
	...
	~SyncedContinuationNode()
	{
		...
		apply(DetachFunctor<D, SyncedContinuationNode, std::shared_ptr<SignalNode<D, TDepValues> >...>(*this),
		      deps_);
