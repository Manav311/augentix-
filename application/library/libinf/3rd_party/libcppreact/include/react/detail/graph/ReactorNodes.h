...
/***************************************/ REACT_IMPL_BEGIN /**************************************/
        ...
        /// ReactorNode
        ///////////////////////////////////////////////////////////////////////////////////////////////////
        template <typename D, typename TContext>
        class ReactorNode : public NodeBase<D> {
	...
	template <typename E> E &Await(const std::shared_ptr<EventStreamNode<D, E> > &events)
	{
	...
	template <typename S> const S &Get(const std::shared_ptr<SignalNode<D, S> > &sigPtr)
	{
    ...
    private:
	template <typename E> bool checkEvent(const std::shared_ptr<EventStreamNode<D, E> > &events)
	{
		if (turnPtr_ == nullptr)
			return false;
