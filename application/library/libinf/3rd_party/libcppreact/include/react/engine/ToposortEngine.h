        ...
        namespace toposort
{
	...
	/// Functors
	///////////////////////////////////////////////////////////////////////////////////////////////////
	template <typename T> struct GetLevelFunctor {
	...
	template <typename T> struct GetWeightFunctor {
	...
	/// EngineBase
	///////////////////////////////////////////////////////////////////////////////////////////////////
	template <typename TNode, typename TTurn> class EngineBase : public IReactiveEngine<TNode, TTurn> {
	    public:
	...
	class ParEngineBase : public EngineBase<ParNode, ParTurn> {
		...
		using TopoQueueT =
		        ConcurrentTopoQueue<ParNode *, grain_size, GetLevelFunctor<ParNode>, GetWeightFunctor<ParNode> >;
...
template <> class ToposortEngine<REACT_IMPL::sequential_propagation> : public REACT_IMPL::toposort::SeqEngineBase {
};

template <> class ToposortEngine<REACT_IMPL::parallel_propagation> : public REACT_IMPL::toposort::ParEngineBase {
};
