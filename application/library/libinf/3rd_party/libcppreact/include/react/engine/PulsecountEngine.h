        ...
        namespace pulsecount
{
	...
	/// Node
	///////////////////////////////////////////////////////////////////////////////////////////////////
	enum class ENodeMark { unmarked, visited, should_update };

	enum class ENodeState { unchanged, changed, dyn_defer, dyn_repeat };
...
template <> class PulsecountEngine<REACT_IMPL::parallel_propagation> : public REACT_IMPL::pulsecount::EngineBase {
};
