...
/***************************************/ REACT_IMPL_BEGIN /**************************************/
	...
	template <T x> void Set()
	{
		flags_ |= 1 << x;
	}

	template <T x> void Clear()
	{
		flags_ &= ~(1 << x);
	}

	template <T x> bool Test() const
	{
		return (flags_ & (1 << x)) != 0;
	}
...
/// NodeVector
///////////////////////////////////////////////////////////////////////////////////////////////////
template <typename TNode> class NodeVector {
    private:
...
template <typename T, size_t N> class NodeBuffer {
    public:
