...
template <int> bool not_the_first_call()
{
...
#define TRACE \
	Harness::internal::tracer.set_trace_info(Harness::internal::Tracer::need_lf, HARNESS_TRACE_ORIG_INFO)->trace
...
#define TRACEP                                                                                          \
	Harness::internal::tracer                                                                       \
	        .set_trace_info(Harness::internal::Tracer::prefix | Harness::internal::Tracer::need_lf, \
	                        HARNESS_TRACE_ORIG_INFO)                                                \
	        ->trace
