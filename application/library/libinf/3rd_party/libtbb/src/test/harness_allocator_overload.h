...
#define MALLOC_WINDOWS_OVERLOAD_ENABLED \
	((_WIN32 || _WIN64) && !__TBB_WIN8UI_SUPPORT && _MSC_VER >= 1500 && !(_MSC_VER == 1900 && _DEBUG))
...
#define HARNESS_SKIP_TEST                                                                                            \
	((!MALLOC_WINDOWS_OVERLOAD_ENABLED && !MALLOC_UNIXLIKE_OVERLOAD_ENABLED && !MALLOC_ZONE_OVERLOAD_ENABLED) || \
	 __TBB_MIC_OFFLOAD)
