...
#define DLD(s, h)                                                              \
	{                                                                      \
#s, (pointer_to_handler *)(void *)(&h), (pointer_to_handler)&s \
	}
#else
#define DLD(s, h)                                      \
	{                                              \
...
**/
bool dynamic_link(const char *library, const dynamic_link_descriptor descriptors[], size_t required,
                  dynamic_link_handle *handle = 0, int flags = DYNAMIC_LINK_ALL);
