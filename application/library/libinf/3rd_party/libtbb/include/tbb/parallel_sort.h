...
void parallel_quick_sort(RandomAccessIterator begin, RandomAccessIterator end, const Compare &comp)
{
	...
	parallel_for(blocked_range<RandomAccessIterator>(k + 1, end),
	             quick_sort_pretest_body<RandomAccessIterator, Compare>(comp), auto_partitioner(), my_context);
...
/** @ingroup algorithms **/
template <typename RandomAccessIterator> inline void parallel_sort(RandomAccessIterator begin, RandomAccessIterator end)
{
...
/** @ingroup algorithms **/
template <typename Range, typename Compare> void parallel_sort(Range &rng, const Compare &comp)
{
...
/** @ingroup algorithms **/
template <typename Range, typename Compare> void parallel_sort(const Range &rng, const Compare &comp)
{
	parallel_sort(tbb::internal::first(rng), tbb::internal::last(rng), comp);
}
...
/** @ingroup algorithms **/
template <typename Range> void parallel_sort(Range &rng)
{
...
/** @ingroup algorithms **/
template <typename Range> void parallel_sort(const Range &rng)
{
	parallel_sort(tbb::internal::first(rng), tbb::internal::last(rng));
}
...
/** @ingroup algorithms **/
template <typename T> inline void parallel_sort(T *begin, T *end)
{
