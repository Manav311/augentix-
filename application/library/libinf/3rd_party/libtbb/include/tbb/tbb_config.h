...
#define __TBB_CPP11_RVALUE_REF_PRESENT                                                                          \
	((__GXX_EXPERIMENTAL_CXX0X__ && (__TBB_GCC_VERSION >= 40300 || _LIBCPP_VERSION) || _MSC_VER >= 1600) && \
...
#define __TBB_INITIALIZER_LISTS_PRESENT                    \
	__INTEL_CXX11_MODE__ &&__INTEL_COMPILER >= 1400 && \
	        (_MSC_VER >= 1800 || __TBB_GCC_VERSION >= 40400 || _LIBCPP_VERSION)
#endif
...
#define __TBB_NOEXCEPT_PRESENT \
	__INTEL_CXX11_MODE__ &&__INTEL_COMPILER >= 1300 && (__TBB_GCC_VERSION >= 40600 || _LIBCPP_VERSION || _MSC_VER)
#define __TBB_CPP11_STD_BEGIN_END_PRESENT \
	(_MSC_VER >= 1700 ||              \
	 __GXX_EXPERIMENTAL_CXX0X__ && __INTEL_COMPILER >= 1310 && (__TBB_GCC_VERSION >= 40600 || _LIBCPP_VERSION))
...
#define __TBB_CPP11_DEFAULT_FUNC_TEMPLATE_ARGS_PRESENT \
	(_MSC_VER >= 1800 || __GXX_EXPERIMENTAL_CXX0X__ && __INTEL_COMPILER >= 1210)
#elif __clang__
...
#define __TBB_CPP11_RVALUE_REF_PRESENT \
	(__has_feature(__cxx_rvalue_references__) && (__TBB_GCC_VERSION >= 40300 || _LIBCPP_VERSION))
...
#define __TBB_DEFAULTED_AND_DELETED_FUNC_PRESENT \
	(__has_feature(__cxx_defaulted_functions__) && __has_feature(__cxx_deleted_functions__))
...
#define __TBB_EXCEPTION_PTR_PRESENT \
	(__GXX_EXPERIMENTAL_CXX0X__ && __TBB_GCC_VERSION >= 40404 && __GCC_HAVE_SYNC_COMPARE_AND_SWAP_4)
...
#define __TBB_CPP11_TYPE_PROPERTIES_PRESENT \
	(_LIBCPP_VERSION || _MSC_VER >= 1700 || (__TBB_GCC_VERSION >= 50000 && __GXX_EXPERIMENTAL_CXX0X__))
...
#define __TBB_MOVE_IF_NOEXCEPT_PRESENT                                                   \
	(__GXX_EXPERIMENTAL_CXX0X__ && __TBB_GCC_VERSION >= 40700 || _MSC_VER >= 1900 || \
	 __clang__ && _LIBCPP_VERSION && __TBB_NOEXCEPT_PRESENT)
...
#define __TBB_ALLOCATOR_TRAITS_PRESENT                                    \
	(__cplusplus >= 201103L && _LIBCPP_VERSION || _MSC_VER >= 1700 || \
	 __GXX_EXPERIMENTAL_CXX0X__ && __TBB_GCC_VERSION >= 40700 &&      \
	         !(__TBB_GCC_VERSION == 40700 && __TBB_DEFINE_MIC))
#define __TBB_MAKE_EXCEPTION_PTR_PRESENT \
	(__TBB_EXCEPTION_PTR_PRESENT && (_MSC_VER >= 1700 || __TBB_GCC_VERSION >= 40600 || _LIBCPP_VERSION))
...
#define __TBB_TSX_INTRINSICS_PRESENT \
	((__RTM__ || _MSC_VER >= 1700 || __INTEL_COMPILER >= 1300) && !__TBB_DEFINE_MIC && !__ANDROID__)
...
#define __TBB_ICC_12_0_INL_ASM_FSTCW_BROKEN 1
        ...
        (__INTEL_COMPILER < 1110 || __INTEL_COMPILER == 1110 && __INTEL_COMPILER_BUILD_DATE < 20091012)
...
#define __TBB_IF_NO_COPY_CTOR_MOVE_SEMANTICS_BROKEN \
	(_MSC_VER && (__INTEL_COMPILER >= 1300 && __INTEL_COMPILER <= 1310) && !__INTEL_CXX11_MODE__)

#if __TBB_CPP11_RVALUE_REF_PRESENT
//Some compilers added implicit generation of move constructor & assignment operator in a later version
#if __INTEL_COMPILER
#define __TBB_CPP11_IMPLICIT_MOVE_MEMBERS_GENERATION_BROKEN \
	(__INTEL_COMPILER < 1400 || __INTEL_COMPILER == 1600 || _MSC_VER <= 1800)
#elif _MSC_VER
...
#define __TBB_VARIADIC_PARALLEL_INVOKE                                                     \
	(TBB_PREVIEW_VARIADIC_PARALLEL_INVOKE && __TBB_CPP11_VARIADIC_TEMPLATES_PRESENT && \
	 __TBB_CPP11_RVALUE_REF_PRESENT)
#define __TBB_FLOW_GRAPH_CPP11_FEATURES                                                                           \
	(__TBB_CPP11_VARIADIC_TEMPLATES_PRESENT && __TBB_CPP11_RVALUE_REF_PRESENT && __TBB_CPP11_AUTO_PRESENT) && \
...
#define __TBB_PREVIEW_OPENCL_NODE \
	(__TBB_FLOW_GRAPH_CPP11_FEATURES && TBB_PREVIEW_FLOW_GRAPH_NODES && !TBB_IMPLEMENT_CPP0X)
