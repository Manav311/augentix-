...
ref class Form1 : public System::Windows::Forms::Form {
	...
	Form1(void)
	{
		...
		m_board2->Location = System::Drawing::Point(2 + boardWidth * BOARD_SQUARE_SIZE + m_sepWidth / 2,
		                                            m_ribbonHeight + menuStrip1->Height);
    ...
    private:
	System::Windows::Forms::ToolStripMenuItem ^ seedToolStripMenuItem;
    ...
    private:
	System::Windows::Forms::Label ^ Sequential;

    private:
	System::Windows::Forms::Label ^ label1;

    private:
	static const int m_sepWidth = 5;

    private:
	static const int m_ribbonHeight = 26;
    ...
    private:
	System::Windows::Forms::Label ^ seqGen;

    private:
	System::Windows::Forms::Label ^ parGen;
...
#pragma region Windows Form Designer generated code
	void InitializeComponent(void)
	{
		...
		this->menuStrip1->ItemClicked += gcnew System::Windows::Forms::ToolStripItemClickedEventHandler(
		        this, &Form1::menuStrip1_ItemClicked);
		//
		...
		//
		this->gameToolStripMenuItem->DropDownItems->AddRange(
		        gcnew cli::array<System::Windows::Forms::ToolStripItem ^>(3){ this->seedToolStripMenuItem,
		...
		this->Sequential->Font = (gcnew System::Drawing::Font(
...
#pragma endregion
    ...
    private:
	System::Void menuStrip1_ItemClicked(System::Object ^ sender,
