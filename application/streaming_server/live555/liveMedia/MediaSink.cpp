...
void OutPacketBuffer::extract(unsigned char *to, unsigned numBytes, unsigned fromPosition)
{
	...
	memcpy(to, &fBuf[realFromPosition], numBytes);
}
...
void OutPacketBuffer::setOverflowData(unsigned overflowDataOffset, unsigned overflowDataSize,
