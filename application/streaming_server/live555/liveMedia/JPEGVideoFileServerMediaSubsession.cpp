...
JPEGVideoFileServerMediaSubsession *JPEGVideoFileServerMediaSubsession::createNew(UsageEnvironment &env,
                                                                                  char const *fileName,
...
JPEGVideoFileServerMediaSubsession::JPEGVideoFileServerMediaSubsession(UsageEnvironment &env, char const *fileName,
...
FramedSource *JPEGVideoFileServerMediaSubsession::createNewStreamSource(unsigned /*clientSessionId*/,
                                                                        unsigned &estBitrate)
{
