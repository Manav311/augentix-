...
AMRAudioFileSink::AMRAudioFileSink(UsageEnvironment &env, FILE *fid, unsigned bufferSize,
...
AMRAudioFileSink *AMRAudioFileSink::createNew(UsageEnvironment &env, char const *fileName, unsigned bufferSize,
...
void AMRAudioFileSink::afterGettingFrame(unsigned frameSize, unsigned numTruncatedBytes,
