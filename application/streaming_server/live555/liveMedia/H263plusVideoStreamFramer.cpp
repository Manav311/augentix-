...
///////////////////////////////////////////////////////////////////////////////
H263plusVideoStreamFramer::H263plusVideoStreamFramer(UsageEnvironment &env, FramedSource *inputSource,
...
///////////////////////////////////////////////////////////////////////////////
void H263plusVideoStreamFramer::continueReadProcessing(void *clientData, unsigned char * /*ptr*/, unsigned /*size*/,
...
void H263plusVideoStreamFramer::continueReadProcessing()
{
	...
	if (acquiredFrameSize > 0) {
		...
		//    fNumTruncatedBytes = fParser->numTruncatedBytes(); // not needed so
		//    far
