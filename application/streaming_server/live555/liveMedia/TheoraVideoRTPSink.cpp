...
{
	return new TheoraVideoRTPSink(env, RTPgs, rtpPayloadFormat, identificationHeader, identificationHeaderSize,
                                                  ...
                                                  char const *configStr)
{
	...
	TheoraVideoRTPSink *resultSink =
	        new TheoraVideoRTPSink(env, RTPgs, rtpPayloadFormat, identificationHeader, identificationHeaderSize,
	                               commentHeader, commentHeaderSize, setupHeader, setupHeaderSize, identField);
        ...
        , fFmtpSDPLine(NULL)
{
	...
	sprintf(fFmtpSDPLine,
	        "a=fmtp:%d "
	        "sampling=%s;width=%u;height=%u;delivery-method=out_"
	        "band/rtsp;configuration=%s\r\n",
...
void TheoraVideoRTPSink::doSpecialFrameHandling(unsigned fragmentationOffset, unsigned char *frameStart,
