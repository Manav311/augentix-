...
class MPEG1or2VideoStreamParser : public MPEGVideoStreamParser {
    public:
	MPEG1or2VideoStreamParser(MPEG1or2VideoStreamFramer *usingSource, FramedSource *inputSource,
...
MPEG1or2VideoStreamFramer::MPEG1or2VideoStreamFramer(UsageEnvironment &env, FramedSource *inputSource,
                                                     Boolean iFramesOnly, double vshPeriod, Boolean createParser)
...
MPEG1or2VideoStreamFramer *MPEG1or2VideoStreamFramer::createNew(UsageEnvironment &env, FramedSource *inputSource,
                                                                Boolean iFramesOnly, double vshPeriod)
{
...
MPEG1or2VideoStreamParser::MPEG1or2VideoStreamParser(MPEG1or2VideoStreamFramer *usingSource, FramedSource *inputSource,
                                                     Boolean iFramesOnly, double vshPeriod)
...
#ifdef DEBUG
		fprintf(stderr, "MPEG1or2VideoStreamParser::parse() EXCEPTION (This is "
...
unsigned MPEG1or2VideoStreamParser::parseVideoSequenceHeader(Boolean haveSeenStartCode)
{
	...
	fprintf(stderr,
	        ...
	        "aspect_ratio_information: %d, frame_rate_code: %d (=>%f "
	        "fps), bit_rate_value: %d (=>%d bps), vbv_buffer_size_value: "
	        "%d\n",
...
unsigned MPEG1or2VideoStreamParser::parseGOPHeader(Boolean haveSeenStartCode)
{
...
#if defined(DEBUG) || defined(DEBUG_TIMESTAMPS)
	fprintf(stderr,
	        "time_code: 0x%07x, drop_frame %d, hours %d, minutes %d, "
	        "seconds %d, pictures %d\n",
	...
	usingSource()->setTimeCode(time_code_hours, time_code_minutes, time_code_seconds, time_code_pictures,
