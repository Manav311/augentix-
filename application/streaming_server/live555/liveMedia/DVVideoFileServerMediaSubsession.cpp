...
DVVideoFileServerMediaSubsession::DVVideoFileServerMediaSubsession(UsageEnvironment &env, char const *fileName,
...
FramedSource *DVVideoFileServerMediaSubsession::createNewStreamSource(unsigned /*clientSessionId*/,
                                                                      unsigned &estBitrate)
{
	...
	DVVideoStreamFramer *framer =
	        DVVideoStreamFramer::createNew(envir(), fileSource, True /*the file source is seekable*/);
...
void DVVideoFileServerMediaSubsession::setStreamSourceDuration(FramedSource *inputSource, double streamDuration,
                                                               u_int64_t &numBytes)
{
	// First, get the file source from "inputSource" (a framer):
	DVVideoStreamFramer *framer = (DVVideoStreamFramer *)inputSource;
