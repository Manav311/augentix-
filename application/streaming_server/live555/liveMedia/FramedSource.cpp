                                ...
                                void *afterGettingClientData, onCloseFunc *onCloseFunc, void *onCloseClientData)
{
	...
	if (fIsCurrentlyAwaitingData) { /*if true means*/
		/*if last time failed to get source, this flag == true,
		but source is trigger by timerfd and interval little less then 1/FPS
		so some time failed to get source is normal*/
	}
