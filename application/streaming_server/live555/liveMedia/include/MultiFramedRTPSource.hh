...
class MultiFramedRTPSource : public RTPSource {
	...
	MultiFramedRTPSource(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
	                     unsigned rtpTimestampFrequency, BufferedPacketFactory *packetFactory = NULL);
	// virtual base class
...
class BufferedPacket {
	...
	void assignMiscParams(unsigned short rtpSeqNo, unsigned rtpTimestamp, struct timeval presentationTime,
	...
	// The above function has been deprecated.  Instead, new subclasses should
	// use:
	virtual void getNextEnclosedFrameParameters(unsigned char *&framePtr, unsigned dataSize, unsigned &frameSize,
