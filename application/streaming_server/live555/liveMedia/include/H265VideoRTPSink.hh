...
class H265VideoRTPSink : public H264or5VideoRTPSink {
	...
	static H265VideoRTPSink *createNew(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
	                                   ...
	                                   u_int8_t const *pps, unsigned ppsSize, unsigned profileSpace,
	                                   unsigned profileId, unsigned tierFlag, unsigned levelId,
	...
	// This avoids us having to 'pre-read' from the input source in order to get
	// these values.
	static H265VideoRTPSink *createNew(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
	...
	H265VideoRTPSink(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
	                 u_int8_t const *vps = NULL, unsigned vpsSize = 0, u_int8_t const *sps = NULL,
	                 unsigned spsSize = 0, u_int8_t const *pps = NULL, unsigned ppsSize = 0,
	                 unsigned profileSpace = 0, unsigned profileId = 1, unsigned tierFlag = 0,
	                 unsigned levelId = 93, char const *interopConstraintsStr = NULL);
