...
class VorbisAudioRTPSink : public AudioRTPSink {
	...
	static VorbisAudioRTPSink *createNew(UsageEnvironment &env, Groupsock *RTPgs, u_int8_t rtpPayloadFormat,
	                                     ...
	                                     // The following headers provide the 'configuration' information,
	                                     // for the SDP description:
	...
	// an optional variant of "createNew()" that takes a Base-64-encoded
	...
	VorbisAudioRTPSink(UsageEnvironment &env, Groupsock *RTPgs, u_int8_t rtpPayloadFormat,
	                   u_int32_t rtpTimestampFrequency, unsigned numChannels, u_int8_t *identificationHeader,
    ...
    private:
	u_int32_t fIdent; // "Ident" field used by this stream.  (Only the low 24 bits
	        // of this are used.)
	char *fFmtpSDPLine;
};

// A general function used by both "VorbisAudioRTPSink" and "TheoraVideoRTPSink"
// to construct
// a Base64-encoded 'config' string (for SDP) from "identification", "comment",
// "setup" headers.
// (Note: The result string was heap-allocated, and the caller should delete[]
// it afterwards.)
