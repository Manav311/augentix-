...
// As above, but includes the size of the input string (i.e., the number of
// bytes to decode) as a parameter.
// This saves an extra call to "strlen()" if we already know the length of the
// input string.
