...
class MPEG2TransportFileServerMediaSubsession : public FileServerMediaSubsession {
    public:
	static MPEG2TransportFileServerMediaSubsession *createNew(UsageEnvironment &env, char const *dataFileName,
	                                                          char const *indexFileName, Boolean reuseFirstSource);

    protected:
	MPEG2TransportFileServerMediaSubsession(UsageEnvironment &env, char const *fileName,
	...
	// Note that because - to implement 'trick play' operations - we're operating
	// on
	...
	// The virtual functions thare are usually implemented by
...
// a given "MPEG2TransportFileServerMediaSubsession" - i.e., Transport Stream
// file).
// It is used only within the implementation of
// "MPEG2TransportFileServerMediaSubsession", but is included here,
// in case subclasses of "MPEG2TransportFileServerMediaSubsession" want to use
// it.
