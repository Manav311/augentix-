...
**********/
// "liveMedia"
// Copyright (c) 1996-2014 Live Networks, Inc.  All rights reserved.// A filter
// that converts a MPEG Transport Stream file - with corresponding index file
...
class MPEG2TransportStreamTrickModeFilter : public FramedFilter {
    public:
	static MPEG2TransportStreamTrickModeFilter *createNew(UsageEnvironment &env, FramedSource *inputSource,
	...
	enum { SKIPPING_FRAME, DELIVERING_SAVED_FRAME, SAVING_AND_DELIVERING_FRAME } fState;
