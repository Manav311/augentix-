...
class OggFileServerDemux : public Medium {
	...
	// requires file reading (to parse the Ogg 'Track' headers) before a new
	...
	// Returns a new "ServerMediaSubsession" object that represents the next media
	// track
    ...
    private:
	OggFileServerDemux(UsageEnvironment &env, char const *fileName, onCreationFunc *onCreation,
	                   void *onCreationClientData);
