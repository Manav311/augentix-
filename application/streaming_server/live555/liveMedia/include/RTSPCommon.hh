...
Boolean parseRTSPRequestString(char const *reqStr, unsigned reqStrSize, char *resultCmdName,
                               ...
                               char *resultSessionId, unsigned resultSessionIdMaxSize, unsigned &contentLength);
...
// Returns True iff the RTSP command "commandName" is mentioned as one of the
// commands supported in "optionsResponseString"
