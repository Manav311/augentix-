...
class H264VideoRTPSource : public MultiFramedRTPSource {
    public:
	static H264VideoRTPSource *createNew(UsageEnvironment &env, Groupsock *RTPgs, unsigned char rtpPayloadFormat,
...
// "sprop-parameter-sets" string (in the SDP description for a H.264/RTP
// stream).
// The value is returned as an array (length "numSPropRecords") of
// "SPropRecord"s.
// This array is dynamically allocated by this routine, and must be delete[]d by
// the caller.
