...
class MP3ADUinterleaverBase : public FramedFilter {
	...
	virtual void afterGettingFrame(unsigned numBytesRead, struct timeval presentationTime,
...
class MP3ADUinterleaver : public MP3ADUinterleaverBase {
    public:
	static MP3ADUinterleaver *createNew(UsageEnvironment &env, Interleaving const &interleaving,
