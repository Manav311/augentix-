...
// A hack that allows a handler for RTP/RTCP packets received over TCP to
// process RTSP commands that may also appear within
// the same TCP connection.  A RTSP server implementation would supply a
// function like this - as a parameter to
...
class RTPInterface {
	...
	Boolean handleRead(unsigned char *buffer, unsigned bufferMaxSize, unsigned &bytesRead,
	...
	// A hack for supporting handlers for RTCP packets arriving interleaved over
	// TCP:
