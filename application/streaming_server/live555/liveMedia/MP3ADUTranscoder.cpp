...
MP3ADUTranscoder *MP3ADUTranscoder::createNew(UsageEnvironment &env, unsigned outBitrate /* in kbps */,
...
void MP3ADUTranscoder::afterGettingFrame(void *clientData, unsigned numBytesRead, unsigned numTruncatedBytes,
...
void MP3ADUTranscoder::afterGettingFrame1(unsigned numBytesRead, unsigned numTruncatedBytes,
                                          struct timeval presentationTime, unsigned durationInMicroseconds)
{
