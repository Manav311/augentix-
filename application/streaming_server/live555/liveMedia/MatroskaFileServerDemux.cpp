...
void MatroskaFileServerDemux::createNew(UsageEnvironment &env, char const *fileName, onCreationFunc *onCreation,
...
MatroskaFileServerDemux::MatroskaFileServerDemux(UsageEnvironment &env, char const *fileName,
