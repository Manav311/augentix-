...
class GroupEId {
    public:
	GroupEId(struct in_addr const &groupAddr, portNumBits portNum, Scope const &scope,
    ...
    private:
	void init(struct in_addr const &groupAddr, struct in_addr const &sourceFilterAddr, portNumBits portNum,
